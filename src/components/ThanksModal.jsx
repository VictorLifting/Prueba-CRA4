...
export const  ThanksModal = ({ onFin }) => {
  return (
    <>
      ...
      >
        ...
        <Box component="p" sx={{ color: "text.pColor" }}>Tu donación es muy importante para nosotros. Comparte esta campaña para poder seguir ayudando
